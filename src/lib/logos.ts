...
// Logo do SUS (SVG em cores oficiais - azul)
export const SUS_LOGO_SVG = `data:image/svg+xml;base64,${btoa(
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 140 80">
    <rect x="18" y="8" width="24" height="64" fill="#003399"/>
    <rect x="8" y="28" width="64" height="24" fill="#003399"/>
    <text x="104" y="50" text-anchor="middle" font-family="Arial, sans-serif" font-size="26" font-weight="700" fill="#003399">SUS</text>
  </svg>`
)}`;
